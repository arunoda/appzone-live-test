...
exports.load = function(appCollection, phoneCollection) {
	return new Model(appCollection, phoneCollection);	
};
...
function Model(appCollection, phoneCollection) {
	...
	*/
	this.getAppUrlByPhone = function(phone, callback) {
		...
		logger.info('receiving appUrl', {phone: phone, appUrl: appUrl});
